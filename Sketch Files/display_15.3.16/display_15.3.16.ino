...
//    Serial.println(getPayloadLength);
    ...
    if( start == true ){
      ...
      Serial.print("gatewayConnect = false");
      everyFiveSeconds = true;
      Serial.print("everyFiveSeconds = true");
    }
  }
 }
   else {
   ...
   if(topicCallback == "RU_DETAIL_<DE,AD,BE,FF,06,ED>"){
        checkRuDetail = true;
...
{
    Serial.println("<---In Five Seconds--->");
    Serial.print("errorJsonLen :");
    Serial.println(errorJsonLen); 
    Serial.print("errorJson :");
    Serial.println(errorJson);
    ...
    if(getPayloadLength > 0 && topicCallback == "RU_DETAIL_<DE,AD,BE,FF,06,ED>" && errorJsonLen > 0 ) {
            checkRuDetail = false;
            errorJson="";
            errorJsonLen = 0;
            }
    ...
    Serial.println("<---In Five Seconds Endinggggggggggg--->");
    Serial.print("errorJsonLen :");
    Serial.println(errorJsonLen); 
    Serial.print("errorJson :");
    Serial.println(errorJson);
    Serial.println("<---In Five Seconds Endinggggggggg--->");
    }
