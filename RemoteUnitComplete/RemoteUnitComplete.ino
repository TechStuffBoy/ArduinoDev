...
String ruidStr;
String myMacId = "00-11-11-00-00-01";
...
void loop()
{
    if(!client.connected() && ( curState != 0 ) && (curState != 1)) {
    ...
    switch(curState) {
        ...
        case CLIENT_CONNECTED:
            ...
            tftDisplay(myMacId, 2, Yellow ,0,80 ,true,Black,0);
            tftDisplay( "is Connected" , 2, Yellow ,0,120 ,false,Black,0);
            tftDisplay( "Successfully!!", 2, Yellow ,0,160 ,false,Black,500);
...
void ruWelcomeScreen(String companyDescGlobal,String plantDescGlobal,String workCenter_01_DescGlobal, String msg)
{
    ...
    tftDisplay(companyDescGlobal,2,Yellow,0,60, false,Black,0);
    tftDisplay(plantDescGlobal,2,Yellow,0,100, false,Black,0);
...
void operatorWelcomeScreen(boolean isBtnPressed){
    ...
    tftDisplay(operatorNameStr,2,Yellow,0,50, false,Black,0);
    ...
    if( !isBtnPressed ) {
        ...
        tft.setCursor(0, 110);
        center("Recieving Workorder List", 2);
...
void productionOrderScreen(int index) 
{
    ...
    tftDisplay("ProductionOrder List", 2, White, 0, 30, false,Black,0);
    tft.drawLine(0,60,320,60, Red);
    tftDisplayNoCenter("PONo" , 2,Yellow ,10,90, false , Black,0);
    ...
    tftDisplayNoCenter("Material" , 2,Yellow ,10,120, false , Black,0);
    ...
    tftDisplayNoCenter("Quantity" , 2,Yellow ,10,150, false , Black,0);
...
void getProductionOrderDetailsScreen(int index,boolean isBtnPressed)
{
    ...
    tftDisplayNoCenter("PONo" , 2,Yellow ,10,50, false , Black,0);
    ...
    tftDisplayNoCenter("Material" , 2,Yellow ,10,80, false , Black,0);
    ...
    tftDisplayNoCenter("Quantity" , 2,Yellow ,10,110, false , Black,0);
...
void confirmStartScreen()
{
     ...
     tftDisplay("Check Raw Material and" , 2,Yellow ,0,30, true , Black,0);
     tftDisplay("Readiness of the SAP" , 2,Yellow ,0,60, false , Black,0);
     tftDisplayNoCenter("Conf No " , 2,Yellow ,40,90, false , Black,0);
     tftDisplayNoCenter(":" , 3,Yellow ,130,90, false , Black,0);
     tftDisplayNoCenter(String(confirmNoPtrArray) , 2,Red ,150,90, false , Black,0);
