...
void setup(){
    Serial.begin(9600);
    //Wire.begin(0x04);
    initSlave(0x04); // Function to initilaize slave
}
void loop()
{
     masterWantsToReadSlave();
     slaveWriteOneByteBackToMaster(34);
     slaveWriteOneByteBackToMaster(48);
     slaveWriteOneByteBackToMaster(46);
     slaveWriteLastByteBackToMaster(90);
     delay(40);
}
