...
void setup()
{
    ...
    Serial.begin(9600);
//    Wire.begin( 0x04 | 0x02 | 0x01 );
//    Wire.onRequest(sendData);
//    TWAMR = ( 0x04 | 0x02 | 0x01 ) << 1;
...
//      readVib(vibPin);
    Serial.print("VAlue of vibration :");
    Serial.println(readVib(vibPin));
...
void sendData(){
    int adr = TWDR >> 1;
    ////i2cData[4]  = vibVal&0x7F;
    if(adr == 0x01) {
        i2cData[0] = potOneVal&0x7F;
        //i2cData[0] = 122;
        i2cData[1] = 0;
