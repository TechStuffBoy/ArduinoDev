...
//Four Outputs for driving stepper Motor
byte DO_00 = 7; //PD7
byte DO_01 = 8; //PB0
byte DO_02 = 9; //PB1
byte DO_03 = 10; //PB2
...
void fwdServo(Servo servo)
{
    ...
    servo.write(77);//rotate the Servo forward, 74, 77(ok)
}

void revServo(Servo servo)
{
    servo.attach(A3); //Attach servo
    servo.write(90); //rotate the Servo reverse , 91 ,94,90(ok)
}
...
//    data[3] = vibrationValue;
    ...
    I2c.write(SLAVE_ADDRESS, 0x00, data[0]); //uint8_t address, uint8_t registerAddress, uint8_t data
    I2c.write(SLAVE_ADDRESS, 0x01, data[1]);
    I2c.write(SLAVE_ADDRESS, 0x02, data[2]);
    I2c.write(SLAVE_ADDRESS, 0x03, data[3]);
